...
<<<<<<< HEAD
                <h2>AuraFit</h2>
=======
                <h2>Olá, {userProfile.name || user.email.split('@')[0]}! 👋</h2>
                <p>Bem-vindo de volta ao AuraFit Premium</p>
>>>>>>> 7134618968fe316e66e28c16a3aa9e91197bd436
              </div>
            </div>
...
=======
            {userPlan === 'pro' && (
              <div className="pro-banner">
                <h3>✅ Você é PRO!</h3>
                <p>🎉 Aproveite treinos ilimitados, acesso total e todas as funcionalidades premium do AuraFit!</p>
              </div>
            )}
            <div className="quick-actions">
              <button className="action-btn" onClick={() => setCurrentPage('home-workouts')}>🏠 Treino em Casa</button>
              <button className="action-btn" onClick={() => setCurrentPage('gym-workouts')}>🏋️ Treino na Academia</button>
              <button className="action-btn" onClick={() => setCurrentPage('nutrition')}>🍎 Ver Nutrição</button>
              <button className="action-btn" onClick={() => setCurrentPage('goals')}>🎯 Minhas Metas</button>
>>>>>>> 7134618968fe316e66e28c16a3aa9e91197bd436
            </div>
          </div>
        )}
...
=======
            ...
            {showAdminPanel && user.email === 'andreyribeiro392@gmail.com' && (
>>>>>>> 7134618968fe316e66e28c16a3aa9e91197bd436
...
=======
      {showAdminPaymentPanel && user.email === 'andreyribeiro392@gmail.com' && (
>>>>>>> 7134618968fe316e66e28c16a3aa9e91197bd436
